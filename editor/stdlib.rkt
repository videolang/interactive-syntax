  ...
  (define editor-snip%
    (class* snip% (readable-snip<%>)
      ...
      (define/private (editor-binding)
        (define identifier (editor->elaborator editor))
        (define binding-mod (first (identifier-binding identifier)))
        (define binding-name (second (identifier-binding identifier)))
        (list binding-mod binding-name))
